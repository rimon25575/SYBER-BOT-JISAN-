...
  version: "1.0.1",
  hasPermssion: 0,
  credits: "𝐂𝐘𝐁𝐄𝐑 ☢️_𖣘 -𝐁𝐎𝐓 ⚠️ JISAN KHAN RIMON_ ☢️",
  description: "goibot",
...
  if ((event.body.toLowerCase() == "jisan") || (event.body.toLowerCase() == "Jisan bai") || (event.body.toLowerCase() == "@JISAN ッ") || (event.body.toLowerCase() == "জিসান")) {
...
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ JISAN ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 jisan.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/a.mlla.mhmrm.pa.mpi.m.ba.mnda.m.645908তার সাতে যোগা যোগ করবেন WhatsApp :- জিসান খান রিমন+0172557***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:JISAN ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস জিসান আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami jisan") || (event.body.toLowerCase() == "cup sala ami jisan") || (event.body.toLowerCase() == "madari")) {
...
     return api.sendMessage("🥰-সজীব-🌺 আমার বস জিসান'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
...
     return api.sendMessage("দূরে গিয়া মর 😪🥱", threadID);
   };
